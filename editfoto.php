<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT nama_foto, keterangan_foto, picture FROM foto WHERE id_foto =:uid');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		SET userName=:uname, userProfession=:ujob, userPic=:upic WHERE userID=:uid');
			...
			if($stmt->execute()){
				...
				window.location.href='http://localhost/AppsDataDiri/index.php?page=datafoto';
				</script>
                <?php
			}
			else{
